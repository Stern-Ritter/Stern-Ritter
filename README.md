...
Занимаюсь backend, люблю решать алгоритмические задачи, писать тесты и изучать новые технологии.  
...
#### 📋  Проекты:
 ...
 - **Otus (Junior Frontend Developer):**
      ...
      - **React чат** - Приложение позволяет отправлять сообщения и отображает входящие сообщения из канала firebase. [[Repo]](https://github.com/Stern-Ritter/react-redux-chat)
      - **Прогноз погоды** - Приложение показывает прогноз погоды в указанном городе, сохраняя 10 последних запросов пользователя. [[Repo]](https://github.com/Stern-Ritter/weather-project)
      - **Игра Жизнь на языке Typescript** - Клеточный автомат, придуманный английским математиком Джоном Конвеем в 1970 году. [[Repo]](https://github.com/Stern-Ritter/game-of-life)
      - **Приложение блог** [[Repo]](https://github.com/Stern-Ritter/Runic)
#### 🎓  Образование:
